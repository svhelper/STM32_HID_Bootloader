...
#elif defined TARGET_GENERIC_F103_PC7
	#define LED1_CLOCK		RCC_APB2ENR_IOPCEN
	#define LED1_BIT_0		SET_BIT(GPIOC->CRL, GPIO_CRL_CNF7_0 | GPIO_CRL_MODE7)
	#define LED1_BIT_1
	#define LED1_MODE
	#define LED1_OFF		WRITE_REG(GPIOC->BSRR, GPIO_BSRR_BS7)
	#define LED1_ON			WRITE_REG(GPIOC->BRR, GPIO_BRR_BR7)
	
	#define XTAL_16MHZ
	#define BOOT_IGNORE_PB2
